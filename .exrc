...
map  <Plug>(ctrlp)
xnoremap $ :call WrapRelativeMotion("$", 1)
...
xnoremap . :normal .
xnoremap 0 :call WrapRelativeMotion("0", 1)
...
nnoremap \bg :call ToggleBG()
xnoremap \bg :call ToggleBG()
onoremap \bg :call ToggleBG()
